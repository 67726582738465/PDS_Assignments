...
barplot(c(sample_98th_percentile, population_98th_percentile),
        ...
        col = c("green","blue")
        main = "Comparison of 98th Percentile",
...
hist(bootstrap_samples[,1], main="Mean Comparision",xlab="Blood Pressure Mean", col = "blue")
abline(v=population_mean_bp, col="red")

hist(bootstrap_samples[,2], main="Standard Comparision",xlab="Blood Pressure Std", col = "green")
abline(v=population_std_bp, col="red")

hist(bootstrap_samples[,3], main="Median Comparision",xlab="Blood Pressure Median", col = "orange")
